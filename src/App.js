    ...
    <>
      <main>
        <section className="container">
          <h3 tabIndex="0">
            {!chores.length ? chores.length : count} Chores Due
          </h3>
          ...
          <button
            ...
            onClick={() =>
              download(JSON.stringify(data), "chore.json", "text/plain")
            }
          >
            Download Chore list
          </button>
          <img
            tabIndex="0"
            id="dust"
            src={`${process.env.PUBLIC_URL}/images/rabbit-dust.gif`}
              ...
              <div className="modal-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div
                    className="form-group"
                    tabIndex="0"
                    aria-label="Enter an Image URL, not required default image will be applied if none is added"
                  >
                    <input
                      id="choreImage"
                      placeholder="http://"
